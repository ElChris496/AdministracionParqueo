...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="http://localhost:8080/AdministracionParqueo/resources/css/style.css">
</head>
    ...
    <main>
        <div class="big-wrapper">
            <header>
                <div class="container">
                    <div class="logo">
                    <img src="http://localhost:8080/AdministracionParqueo/resources/img/auto.png" alt="logo">
                    <h3>Parqueo</h3>
                    </div>
                <div class="links">
                    <ul>
            ...
            <div class="showcase-area">
                ...
                <div class="rigth">
                    <img src="http://localhost:8080/AdministracionParqueo/resources/img/auto.png" alt="car img"class="car">
                </div>
                </div>
            </div>
